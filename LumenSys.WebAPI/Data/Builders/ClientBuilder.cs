    ...
    public class ClientBuilder
    {
        public static void Build(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Client>().HasData(
               new Client
               {
                   Id = 1, Name = "Professor Ut�nio", Cpf = "24929517664", Phone = "7932798495", Email = "utonium@gmail.com", Street = "Rua Meninas", Number = "123", Neighborhood = "Superpoderosas", City = "Townsville", Uf = "NS",
                   CompanyId = 1
               },
               new Client
               {
